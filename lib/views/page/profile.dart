                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: Text(widget.user!.username, style: Global.getCustomFont(Global.BLACK, 13, 'book'))
                          ),
                          Container(
                              padding: const EdgeInsets.only(left: 10, top: 10, bottom: 7, right: 10),
                              child: Text("Name",
                          ...
                          Container(
                              ...
                              child: Row(
                                children: [
                                  Text(widget.user!.nama, style: Global.getCustomFont(Global.BLACK, 13, 'book')),
                                  Container(
                                    width: 14,
                                  ),
                                  InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(
                                          builder: (context) => ChangeNamePage(
                                            widget.user!.nama,
                                            successEditName: (int resMessage, BuildContext ctx) {
                                              if (resMessage == 200) {
